    ...
    return (
        <div className="chibli-post fixed top-0 bottom-0 left-0 right-0 z-999 flex justify-center items-center ">
            ...
            <div className="chibli-post-content relative bg-white lg:max-w-screen-md md:max-w-lg sm:max-w-lg rounded p-4">
                <svg className="w-6 h-6 absolute right-0 top-1 transform hover:rotate-45 transition-transform cursor-pointer" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" onClick={onChibliClose} /></svg>
